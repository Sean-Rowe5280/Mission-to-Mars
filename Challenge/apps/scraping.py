...
def scrape_all():
    ...
    #### Tell Python that hem_data will be using hem_data function ###############
    ...
    data = {
        ...
        "hemispheres": hemisphere_image_urls}    ###### ADDED ################      
...
#### Deliverable 2 #### USE: Mission_to_Mars_Challenge.py
...
## Parse HTML use soup
    ...
    elements=hem_soup.find_all("div", class_="item")
    ...
    for div in elements:
        ...
        hem_scrape["img_url"]=img_url
        hem_scrape["title"]=title
        hemisphere_image_urls.append(hem_scrape)
        browser.back()
